		...
		return JSONResponse(
			{
				...
				"ai_library_match_count": len(onboarding_result.ai_library_matches),
				"ai_library_matches": [asdict(match) for match in onboarding_result.ai_library_matches],
				"capability_profile": asdict(onboarding_result.capability_profile),
