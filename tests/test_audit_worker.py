...
"""
    ...
    expected = "\n".join(
        [
            ...
            "| --- | --- | --- |",
            "| Guardrail robustness | unknown → unknown | PromptDrift does not have enough stored profile evidence for this dimension yet. (low confidence) |",
            "| Capability risk | unknown → unknown | PromptDrift does not have enough stored profile evidence for this dimension yet. (low confidence) |",
            "| Autonomy level | unknown → unknown | PromptDrift does not have enough stored profile evidence for this dimension yet. (low confidence) |",
            "| Governance strength | unknown → unknown | PromptDrift does not have enough stored profile evidence for this dimension yet. (low confidence) |",
            "| Model config posture | unknown → unknown | PromptDrift does not have enough stored profile evidence for this dimension yet. (low confidence) |",
            "| Control surface type | unknown → unknown | PromptDrift does not have enough stored profile evidence for this dimension yet. (low confidence) |",
            "",
            "  - Guardrail robustness: PromptDrift does not have enough stored profile evidence for this dimension yet.",
            "  - Capability risk: PromptDrift does not have enough stored profile evidence for this dimension yet.",
            "  - Autonomy level: PromptDrift does not have enough stored profile evidence for this dimension yet.",
            "  - Governance strength: PromptDrift does not have enough stored profile evidence for this dimension yet.",
            "",
            "<details>",
