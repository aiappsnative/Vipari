...
Vipari exists to make that design-level drift visible, understandable, and governable.

---

## Our value offering

Vipari helps teams govern AI systems in GitHub by detecting how prompts, policies, tool access, and agent wiring drift from an approved baseline.
...
Vipari should help teams decide when an AI-related pull request must be escalated before merge because it changed what the AI is allowed to do, how tightly it is constrained, or how broadly it can act.

---

## What we are building

Vipari is a GitHub-native design drift engine for AI systems.
...
Vipari is built to answer those questions directly from GitHub-visible artifacts.

---

## What we can know without runtime access

Everything Vipari produces must be grounded in information extractable from code, prompts, config, and GitHub metadata.
...
Vipari is not a runtime observability platform.
...
On every PR that touches AI-relevant files, Vipari should explain:
- what changed,
...
Vipari should first win as a high-signal PR reviewer for AI control-surface changes, not as a generic governance dashboard.
...
### Agent history view
For each agent, Vipari should show:
...
Vipari exists to meet that need.

---

## Who this is for

Vipari is for teams building and governing AI systems in software organizations.
...
If it cannot be grounded in GitHub-visible artifacts, it is not core to Vipari.
...
A good Vipari result should help a reviewer answer:
...
- Vipari found real, non-obvious, high-impact AI changes in live repos
...
Vipari makes AI system design drift visible in GitHub before it becomes a production problem.
